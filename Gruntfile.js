  // watchserver: updating static file server script initialized variables
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    // Basic grunt updating static file
...
// replace the above manual load tasks with matchdep
require('matchdep').filterDev('grunt-*').forEach(grunt.loadNpmTasks);

  // Can register two shell commands using an alias
